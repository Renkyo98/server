...
*/
    ...
    */
    ...
    log( "单捞磐 犁且寸: 货 农扁:%d 备林家: %x 脚林家:%x\n",
...
reallocHash( int dbi )
{
    ...
    log( "公瓤沥焊 犁且寸: 货 农扁:%d 备林家: %x 脚林家:%x\n",
