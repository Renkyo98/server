...
#ifdef _CALLBUS
	CHAR_setWorkInt( meindex, NPC_WORK_STARTFLOOR, CHAR_getInt( meindex, CHAR_FLOOR) );
...
#ifdef _CALLBUS
				if( ( CHAR_getWorkInt( meindex, CHAR_WORK_CALLBUS ) == 1 )
					&& ( CHAR_getInt( meindex, CHAR_FLOOR) != CHAR_getWorkInt( meindex, NPC_WORK_STARTFLOOR) 
					|| CHAR_getInt( meindex, CHAR_X) != CHAR_getWorkInt( meindex, NPC_WORK_STARTX)
					|| CHAR_getInt( meindex, CHAR_Y) != CHAR_getWorkInt( meindex, NPC_WORK_STARTY) ) ){
	  ...
	  case 0:
		...
		if( CHAR_getWorkInt( meindex, CHAR_WORK_CALLBUS ) == 1 ){
			if( CHAR_getWorkInt( meindex, CHAR_WORK_CALLBUSTIME ) != -1 ){//被呼叫了
				if( CHAR_getWorkInt( meindex, CHAR_WORK_CALLBUSTIME )+30 < NowTime.tv_sec ){
					CHAR_setWorkInt( meindex, CHAR_WORK_CALLBUSTIME, -1 );
