...
#define CHAR_MAXITEMHAVE (CHAR_STARTITEMARRAY+CHAR_MAXITEMNUM*3) // 咯扁 *3父 眠啊沁澜.

#define CHAR_MAXMAXITEMNUM  (CHAR_MAXITEMNUM*3) // CHAR_MAXITEMNUM 措眉
#define CHAR_MAXMAXITEMHAVE (CHAR_STARTITEMARRAY+CHAR_MAXMAXITEMNUM) // CHAR_MAXITEMHAVE 措眉
...
// (可开) Change 替套装增加功能 (_SUIT_ITEM要开)
	...
	CHAR_WORKSTREETVENDOR_TYPE, // 摆摊类型, 1石币, 2声望, 3气势, 4DP, 5积分, 6金币, 7活力
...
#ifdef _PET_EVOLUTION
#ifdef _PET_FUSION_2
int EVOLUTION_getPetTable( int charaindex, int petindex1, int petindex2 ,int type);
#else
