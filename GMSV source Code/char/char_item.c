...
#define MAXCASINOMAPNUM				150			// ÓÎÀÖ³¡µØÍ¼ÉÏÏÞ
#define MAXACCUMULATION				1000000		// »ý·ÖÉÏÏÞ
typedef struct tagCasinoMapTable
{
	int casinofl;				// ÓÎÀÖ³¡Í¼²ã
	int casinox;				// ÓÎÀÖ³¡£Ø×ù±ê
	int casinoy;				// ÓÎÀÖ³¡£Ù×ù±ê
	int casinotype;			// ¶Ä×¢ÀàÐÍ
	int dropflag;				// ÊÇ·ñ¿ÉÏÂ×¢ flag
	char casinoinfo[64];		// ¶Ä×¢ÀàÐÍËµÃ÷
	int accumulation;			// »ý·Ö
	int stakenum;				// ²ÊÈ¯ÊýÁ¿
}CasinoMapTable;
CasinoMapTable casinomap[MAXCASINOMAPNUM] = 
{
	{ 7008, 13, 13, DICE_BIG, 1, "Å«ÁÖ»çÀ§", 1, 0},
	{ 7008, 14, 13, DICE_BIG, 1, "Å«ÁÖ»çÀ§", 1, 0},
	{ 7008, 15, 13, DICE_BIG, 1, "Å«ÁÖ»çÀ§", 1, 0},
	{ 7008, 16, 13, DICE_BIG, 1, "Å«ÁÖ»çÀ§", 1, 0},
	{ 7008, 17, 13, DICE_BIG, 1, "Å«ÁÖ»çÀ§", 1, 0},
	{ 7008, 13, 14, DICE_BIG, 1, "Å«ÁÖ»çÀ§", 1, 0},
	{ 7008, 14, 14, DICE_BIG, 1, "Å«ÁÖ»çÀ§", 1, 0},
	{ 7008, 15, 14, DICE_BIG, 1, "Å«ÁÖ»çÀ§", 1, 0},
	{ 7008, 16, 14, DICE_BIG, 1, "Å«ÁÖ»çÀ§", 1, 0},
	{ 7008, 17, 14, DICE_BIG, 1, "Å«ÁÖ»çÀ§", 1, 0},
	{ 7008, 13, 15, DICE_BIG, 1, "Å«ÁÖ»çÀ§", 1, 0},
	{ 7008, 14, 15, DICE_BIG, 1, "Å«ÁÖ»çÀ§", 1, 0},
	{ 7008, 15, 15, DICE_BIG, 1, "Å«ÁÖ»çÀ§", 1, 0},
	{ 7008, 16, 15, DICE_BIG, 1, "Å«ÁÖ»çÀ§", 1, 0},
	{ 7008, 17, 15, DICE_BIG, 1, "Å«ÁÖ»çÀ§", 1, 0},
	{ 7008,  8, 13, DICE_SMALL, 1, "ÀÛÀºÁÖ»çÀ§", 1, 0},
	{ 7008,  9, 13, DICE_SMALL, 1, "ÀÛÀºÁÖ»çÀ§", 1, 0},
	{ 7008, 10, 13, DICE_SMALL, 1, "ÀÛÀºÁÖ»çÀ§", 1, 0},
	{ 7008, 11, 13, DICE_SMALL, 1, "ÀÛÀºÁÖ»çÀ§", 1, 0},
	{ 7008, 12, 13, DICE_SMALL, 1, "ÀÛÀºÁÖ»çÀ§", 1, 0},
	{ 7008,  8, 14, DICE_SMALL, 1, "ÀÛÀºÁÖ»çÀ§", 1, 0},
	{ 7008,  9, 14, DICE_SMALL, 1, "ÀÛÀºÁÖ»çÀ§", 1, 0},
	{ 7008, 10, 14, DICE_SMALL, 1, "ÀÛÀºÁÖ»çÀ§", 1, 0},
	{ 7008, 11, 14, DICE_SMALL, 1, "ÀÛÀºÁÖ»çÀ§", 1, 0},
	{ 7008, 12, 14, DICE_SMALL, 1, "ÀÛÀºÁÖ»çÀ§", 1, 0},
	{ 7008,  8, 15, DICE_SMALL, 1, "ÀÛÀºÁÖ»çÀ§", 1, 0},
	{ 7008,  9, 15, DICE_SMALL, 1, "ÀÛÀºÁÖ»çÀ§", 1, 0},
	{ 7008, 10, 15, DICE_SMALL, 1, "ÀÛÀºÁÖ»çÀ§", 1, 0},
	{ 7008, 11, 15, DICE_SMALL, 1, "ÀÛÀºÁÖ»çÀ§", 1, 0},
	{ 7008, 12, 15, DICE_SMALL, 1, "ÀÛÀºÁÖ»çÀ§", 1, 0},

	{ 7005, 22, 21, PET_RACE1, 1, "1¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 23, 21, PET_RACE1, 1, "1¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 24, 21, PET_RACE1, 1, "1¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 25, 21, PET_RACE1, 1, "1¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 26, 21, PET_RACE1, 1, "1¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 27, 21, PET_RACE1, 1, "1¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 28, 21, PET_RACE1, 1, "1¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 22, 24, PET_RACE2, 1, "2¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 23, 24, PET_RACE2, 1, "2¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 24, 24, PET_RACE2, 1, "2¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 25, 24, PET_RACE2, 1, "2¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 26, 24, PET_RACE2, 1, "2¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 27, 24, PET_RACE2, 1, "2¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 28, 24, PET_RACE2, 1, "2¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 22, 27, PET_RACE3, 1, "3¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 23, 27, PET_RACE3, 1, "3¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 24, 27, PET_RACE3, 1, "3¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 25, 27, PET_RACE3, 1, "3¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 26, 27, PET_RACE3, 1, "3¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 27, 27, PET_RACE3, 1, "3¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},
	{ 7005, 28, 27, PET_RACE3, 1, "3¹ø ÆäÆ®·¹ÀÌ½º", 2, 0},

	{ 7003, 21, 15, ROULETTE1, 1, "·ê·¿·¹µå£±", 1, 0}, { 7003, 17, 15, ROULETTE3, 1, "·ê·¿·¹µå£³", 1, 0},
	{ 7003, 13, 15, ROULETTE5, 1, "·ê·¿·¹µå£µ", 1, 0}, { 7003, 21, 21, ROULETTE6, 1, "·ê·¿·¹µå£¶", 1, 0},
	{ 7003, 17, 21, ROULETTE8, 1, "·ê·¿·¹µå£¸", 1, 0}, { 7003, 15, 21, ROULETTE9, 1, "·ê·¿·¹µå£¹", 1, 0},
	{ 7003, 13, 21, ROULETTE10, 1, "·ê·¿·¹µå£±£°", 1, 0}, { 7003, 13, 18, ROULETTE13, 1, "·ê·¿·¹µå£±£³", 1, 0},
	{ 7003,  9, 21, ROULETTE17, 1, "·ê·¿·¹µå£±£·", 1, 0}, { 7003, 21, 18, ROULETTE18, 1, "·ê·¿·¹µå£±£¸", 1, 0},

	{ 7003, 19, 15, ROULETTE22, 1, "·ê·¿±×¸°£²", 1, 0}, { 7003, 15, 15, ROULETTE24, 1, "·ê·¿±×¸°£´", 1, 0},
	{ 7003, 19, 21, ROULETTE27, 1, "·ê·¿±×¸°£·", 1, 0}, { 7003, 11, 15, ROULETTE31, 1, "·ê·¿±×¸°£±£±", 1, 0},
	{ 7003,  9, 15, ROULETTE32, 1, "·ê·¿±×¸°£±£²", 1, 0}, { 7003, 11, 18, ROULETTE34, 1, "·ê·¿±×¸°£±£´", 1, 0},
	{ 7003,  9, 18, ROULETTE35, 1, "·ê·¿±×¸°£±£µ", 1, 0}, { 7003, 11, 21, ROULETTE36, 1, "·ê·¿±×¸°£±£¶", 1, 0},
	{ 7003, 19, 18, ROULETTE39, 1, "·ê·¿±×¸°£±£¹", 1, 0}, { 7003, 17, 18, ROULETTE40, 1, "·ê·¿±×¸°£²£°", 1, 0},
	{ 7003, 17, 24, ROULETTE41, 1, "·ê·¿±×¸°", 1, 0}, { 7003, 16, 24, ROULETTE41, 1, "·ê·¿±×¸°", 1, 0},
	{ 7003, 17, 25, ROULETTE41, 1, "·ê·¿±×¸°", 1, 0}, { 7003, 16, 25, ROULETTE41, 1, "·ê·¿±×¸°", 1, 0},
	{ 7003, 14, 24, ROULETTE42, 1, "·ê·¿±×¸°", 1, 0}, { 7003, 13, 24, ROULETTE42, 1, "·ê·¿±×¸°", 1, 0},
	{ 7003, 14, 25, ROULETTE42, 1, "·ê·¿±×¸°", 1, 0}, { 7003, 13, 25, ROULETTE42, 1, "·ê·¿±×¸°", 1, 0},

    // WON ADD ÐÞÕýµØÍ¼ÉÏµ¥Ë«µÄ´íÎó
	{ 7003, 11, 24, ROULETTE43, 1, "·ê·¿·¹µå", 1, 0}, { 7003, 10, 24, ROULETTE43, 1, "·ê·¿·¹µå", 1, 0},
	{ 7003, 11, 25, ROULETTE43, 1, "·ê·¿·¹µå", 1, 0}, { 7003, 10, 25, ROULETTE43, 1, "·ê·¿·¹µå", 1, 0},
	{ 7003, 20, 24, ROULETTE44, 1, "·ê·¿±×¸°", 1, 0}, { 7003, 19, 24, ROULETTE44, 1, "·ê·¿±×¸°", 1, 0},
	{ 7003, 20, 25, ROULETTE44, 1, "·ê·¿±×¸°", 1, 0}, { 7003, 19, 25, ROULETTE44, 1, "·ê·¿±×¸°", 1, 0},



	{ 7003, 20, 15, (ROULETTE1<<16)+ROULETTE22, 1, "·ê·¿·¹µå£±±×¸°£²", 1, 0},
	{ 7003, 18, 15, (ROULETTE3<<16)+ROULETTE22, 1, "·ê·¿·¹µå£³±×¸°£²", 1, 0},
	{ 7003, 16, 15, (ROULETTE3<<16)+ROULETTE24, 1, "·ê·¿·¹µå£³±×¸°£´", 1, 0},
	{ 7003, 14, 15, (ROULETTE5<<16)+ROULETTE24, 1, "·ê·¿·¹µå£µ±×¸°£´", 1, 0},
	{ 7003, 12, 15, (ROULETTE5<<16)+ROULETTE31, 1, "·ê·¿·¹µå£µ±×¸°£±£±", 1, 0},
	{ 7003, 10, 15, (ROULETTE32<<16)+ROULETTE31, 1, "·ê·¿·¹µå£±£²±×¸°£±£±", 1, 0},

	{ 7003, 20, 18, (ROULETTE18<<16)+ROULETTE39, 1, "·ê·¿·¹µå£±£¸±×¸°£±£¹", 1, 0},
	{ 7003, 18, 18, (ROULETTE40<<16)+ROULETTE39, 1, "·ê·¿·¹µå£²£°±×¸°£±£¹", 1, 0},
	{ 7003, 16, 18, (ROULETTE40<<16)+ROULETTE45, 1, "·ê·¿·¹µå£²£°±×¸°£°£°", 1, 0},
	{ 7003, 14, 18, (ROULETTE13<<16)+ROULETTE45, 1, "·ê·¿·¹µå£±£³±×¸°£°£°", 1, 0},
	{ 7003, 12, 18, (ROULETTE13<<16)+ROULETTE34, 1, "·ê·¿·¹µå£±£³±×¸°£±£´", 1, 0},
	{ 7003, 10, 18, (ROULETTE35<<16)+ROULETTE34, 1, "·ê·¿·¹µå£±£µ±×¸°£±£´", 1, 0},

	{ 7003, 20, 21, (ROULETTE6<<16) +ROULETTE27, 1, "·ê·¿·¹µå£¶±×¸°£·", 1, 0},
	{ 7003, 18, 21, (ROULETTE8<<16) +ROULETTE27, 1, "·ê·¿·¹µå£¸±×¸°£·", 1, 0},
	{ 7003, 16, 21, (ROULETTE8<<16) + ROULETTE9, 1, "·ê·¿·¹µå£¸·¹µå£¹", 1, 0},
	{ 7003, 14, 21, (ROULETTE10<<16)+ ROULETTE9, 1, "·ê·¿·¹µå£±£°·¹µå£¹", 1, 0},
	{ 7003, 12, 21, (ROULETTE10<<16)+ROULETTE36, 1, "·ê·¿·¹µå£±£°±×¸°£±£¶", 1, 0},
	{ 7003, 10, 21, (ROULETTE17<<16)+ROULETTE36, 1, "·ê·¿·¹µå£±£·±×¸°£±£¶", 1, 0},
	{ 7003,  8, 15, ROULETTE51, 1, "ÄÚ½º£±", 1, 0},	//ºáÁÐ
	{ 7003,  8, 18, ROULETTE52, 1, "ÄÚ½º£²", 1, 0},
	{ 7003,  8, 21, ROULETTE53, 1, "ÄÚ½º£³", 1, 0},
	{ 7003,  6, 15, ROULETTE61, 1, "¹øÈ££±£­£±£°", 1, 0},	//1µ½10
	{ 7003,  5, 15, ROULETTE61, 1, "¹øÈ££±£­£±£°", 1, 0},
	{ 7003,  6, 16, ROULETTE61, 1, "¹øÈ££±£­£±£°", 1, 0},
	{ 7003,  5, 16, ROULETTE61, 1, "¹øÈ££±£­£±£°", 1, 0},
	{ 7003, 24, 15, ROULETTE62, 1, "¹øÈ££±£±£­£²£°", 1, 0},	//10µ½11
	{ 7003, 23, 15, ROULETTE62, 1, "¹øÈ££±£±£­£²£°", 1, 0},
	{ 7003, 24, 16, ROULETTE62, 1, "¹øÈ££±£±£­£²£°", 1, 0},
	{ 7003, 23, 16, ROULETTE62, 1, "¹øÈ££±£±£­£²£°", 1, 0},
	{ 7003, 15, 18, ROULETTE45, 1, "Å×ÀÌºí(£°£°)", 1, 0},
...
BOOL CHAR_sendItemData( int charaindex, int *itemgroup, int num)
{
	...
	if( num <= 0 || num > CHAR_getMaxInventory( charaindex )) return FALSE;
...
static void CHAR_sendItemDetachEvent( int charaindex,int itemindex )
{
  ...
  if(ITEM_getInt( itemindex, ITEM_USETIME) > 0){
			...
			snprintf( mesg, sizeof( mesg), "Ð¶ÏÂ%s ÓÐÐ§Ê¹ÓÃÆÚÖÁ %dÄê%dÔÂ%dÈÕ %d:%d:%d", 
...
#endif
	{
		snprintf( mesg, sizeof( mesg), "%s ¾ÆÀÌÅÛÀ» ÇØÁ¦Çß½À´Ï´Ù ", ITEM_getAppropriateName(itemindex) );
	}
	...
	if( !strcmp( ITEM_getChar( itemindex, ITEM_ATTACHFUNC), "ITEM_TotemInstallation") 
			&& CHAR_getWorkInt( charaindex, CHAR_CHARMETAMONO) == 1 ) {
	if( CHAR_getInt( charaindex, CHAR_RIDEPET ) == -1 ){ // Å¾½Â »óÅÂ°¡ ¾Æ´Ò °æ¿ì
	CHAR_setInt( charaindex, CHAR_BASEBASEIMAGENUMBER, CHAR_getInt(charaindex, CHAR_CHARMETAMO));// Ä³¸¯ÅÍ ÀÌ¹ÌÁö º¯½Å
	CHAR_setInt( charaindex, CHAR_BASEIMAGENUMBER, CHAR_getInt(charaindex, CHAR_CHARMETAMO));
	}else{// Å¾½Â »óÅÂÀÏ °æ¿ì
	CHAR_setInt( charaindex, CHAR_BASEIMAGENUMBER, CHAR_getInt(charaindex, CHAR_CHARMETAMORIDE)); // Å¾½Â ÀÌ¹ÌÁö º¯½Å
	}
	...
	CHAR_setInt( charaindex, CHAR_BATTLEHPUP , CHAR_getInt( charaindex, CHAR_BATTLEHP )); // ÀüÅõ ³»±¸·ÂÈ¸º¹ ¸®¼Â
...
static void CHAR_sendItemAttachEvent( int charaindex,int itemindex )
{
  ...
  if(ITEM_getInt( itemindex, ITEM_USETIME) > 0){
			time_t usetime = ITEM_getInt( itemindex, ITEM_USETIME);
			struct tm *tm1 = localtime(&usetime);
			snprintf( mesg, sizeof( mesg), "×°±¸%s ÓÐÐ§Ê¹ÓÃÆÚÖÁ %dÄê%dÔÂ%dÈÕ %d:%d:%d", 
																							ITEM_getChar( itemindex, ITEM_SECRETNAME),
																							tm1->tm_year + 1900,
																							tm1->tm_mon + 1,
																							tm1->tm_mday,
...
#endif
	{
		snprintf( mesg, sizeof( mesg), "%s ¾ÆÀÌÅÛÀ» Âø¿ëÇß½À´Ï´Ù. ",
...
#define LACKOFCLASS {CHAR_talkToCli(index,-1,"·¹º§ÀÌ ºÎÁ·ÇÏ¿© ¾ÆÀÌÅÛ Âø¿ëÀ» ÇÒ ¼ö ¾ø½À´Ï´Ù¡£",CHAR_COLORWHITE);}
#define CANNOTEQUIP {CHAR_talkToCli(index,-1,"±×°ÍÀ» Âø¿ëÇÒ ¼ö ¾ø½À´Ï´Ù¡£",CHAR_COLORRED);}
#define CANNOTEQUIP2 {CHAR_talkToCli(index,-1,"°°Àº Á¾·ùÀÇ ¾ÆÀÌÅÛÀ» Âø¿ëÇÒ ¼ö ¾ø½À´Ï´Ù¡£",CHAR_COLORRED);}
#define CANNOTEXCHANGE {CHAR_talkToCli(index,-1,"¼­·Î ±³È¯ÇÒ ¼ö ¾ø½À´Ï´Ù¡£",CHAR_COLORRED);}
#define CANNOTMOVE  {CHAR_talkToCli(index,-1,"±×·¸°Ô ÀÌµ¿ÇÒ ¼ö ¾ø½À´Ï´Ù¡£",CHAR_COLORRED);}
											...
											int toindex )
{
	...
	if( ITEM_getInt( fromid, ITEM_NEEDPROFESSION) != 0 ){
		if( CHAR_getInt( index, PROFESSION_CLASS ) != ITEM_getInt( fromid, ITEM_NEEDPROFESSION) ){
			CHAR_talkToCli( index, -1, "¸ÃÖ°ÒµÎÞ·¨×°±¸´ËÎïÆ·£¡", CHAR_COLORYELLOW );
			return FALSE;
		}
	}
#endif
...
#ifdef _FIXBUG_ATTACKBOW
	{
		if( CHAR_getWorkInt( index, CHAR_WORKITEMMETAMO) > 0 ||
			...
			|| CHAR_getWorkInt( index, CHAR_WORKFOXROUND ) != -1){ //ÈôÊÇ±ä³ÉÐ¡ºüÀê

			int armtype = ITEM_getInt( fromid, ITEM_TYPE );

			if( armtype == ITEM_BOW || armtype == ITEM_BOUNDTHROW ||
				armtype == ITEM_BREAKTHROW || armtype == ITEM_BOOMERANG)	{
				CHAR_talkToCli( index, -1, "±äÉíÎÞ·¨Ê¹ÓÃÔ¶¾àÀëÎäÆ÷£¡", CHAR_COLORYELLOW );
				return FALSE;
			}
		}
	}
	...
	if( ITEM_getInt( fromid, ITEM_ID) == ANGELITEM ) {
		...
		if( mindex < 0 ||
			...
			CHAR_talkToCli( index, -1, "Õâ²¢²»ÊÇÊôì¶ÄãµÄÐÅÎï£¬ÎÞ·¨×°±¸¡£", CHAR_COLORYELLOW );
			return FALSE;
		}
	}
#endif
...
{
	return min(CHAR_STARTITEMARRAY + CHAR_MAXITEMNUM + CHAR_MAXITEMNUM * CHAR_getInt( charaindex, CHAR_EXTRA_INVENTORY ), CHAR_MAXMAXITEMHAVE );
}
...
//		print( "ANDY itemindex=%d err\n", itemindex);
	...
	//²»µÈì¶ÁÏÀí ºÍ ÆäËû
	if( ITEM_getInt( itemindex,ITEM_TYPE) != ITEM_OTHER &&ITEM_getInt( itemindex,ITEM_TYPE) != ITEM_DISH ) {
		CHAR_EquipPlace ep;
	...
	if( usefunc ){
		{
			LogItem(
				CHAR_getChar( charaindex, CHAR_NAME ), /* Æ½ÅÒ·Â’o */
		...
		{
			char ansmsg[256];
			strcpysafe( ansmsg, sizeof(ansmsg),"Ê²÷áÒ²Ã»ÓÐ·¢Éú¡£");
...
void CHAR_DropStakeByDropItem( int charaindex, int itemcharaindex, int itemindex, int fl, int x, int y)
{
	...
	if( dropflag >= MAXSTAKENUM){
		snprintf( tmpbuf, sizeof( tmpbuf), "ÄãÒÑ¾­ÏÂ×¢Îå´ÎÁË£¬ÎÞ·¨ÔÙÏÂ×¢£¡");
	...
	for (j = 0; j < arraysizeof( casinomap); j++){
		...
		if( casinomap[j].dropflag == 0 ){
			CHAR_talkToCli( charaindex, -1, "ÏÖÔÚÎÞ·¨ÏÂ×¢£¡", CHAR_COLORYELLOW);
			return;
		}else{
			int objindex;
			objindex = CHAR_DropItemAbsolute( itemindex, fl, x, y, FALSE );
...
void CHAR_DropItem( int charaindex,  int itemcharaindex )
{
	...
	if( CHAR_getWorkInt( charaindex, CHAR_WORKBATTLEMODE ) != BATTLE_CHARMODE_NONE ){
		CHAR_talkToCli( charaindex, -1, "ÀüÅõ Áß¿¡´Â ¾ÆÀÌÅÛÀ» ¹ö¸± ¼ö ¾ø¾î¿ä", CHAR_COLORYELLOW );
		return;
	}
#ifdef _AVID_TRADETRYBUG  //¶ªµÀ¾ß×°±¸
	if( CHAR_getWorkInt(charaindex, CHAR_WORKTRADEMODE) != CHAR_TRADE_FREE){
		CHAR_talkToCli( charaindex, -1, "±³È¯ »óÅÂ¿¡¼­´Â ¾ÆÀÌÅÛÀ» ¹ö¸± ¼ö ¾ø¾î¿ä", CHAR_COLORYELLOW );
		return;
	}
#endif
    ...
    lssproto_WN_send( getfdFromCharaIndex( charaindex), WINDOW_MESSAGETYPE_MESSAGE, WINDOW_BUTTONTYPE_OKCANCEL,CHAR_WINDOWTYPE_DROPITEM,-1,dropmsg);
		return;
	}
#endif
	...
	if( CHAR_FindAroundUsabilitySpace( charaindex, itemindex, &fl, &x, &y) == FALSE ){
		CHAR_talkToCli( charaindex, -1, "ÁÖº¯¿¡ ¾ÆÀÌÅÛÀÌ ¸¹¾Æ¼­ ¹ö¸±¼ö ¾ø½À´Ï´Ù¡£", CHAR_COLORYELLOW );
		return;
	}
	...
	if( ret == 1 ){	//-1 ÎïÆ·²»´æÔÚ 1 ÏûÊ§ 0 Ò»°ãÎïÆ·
		...
		{
			char tmpbuf[256];
			sprintf(tmpbuf,"¾ÆÀÌÅÛ [%s](ÀÌ)°¡ [%d]ÃÊ ÈÄ¿¡ »ç¶óÁý´Ï´Ù",ITEM_getChar( itemindex, ITEM_NAME),getItemdeletetime());
			CHAR_talkToCli( charaindex, -1, tmpbuf, CHAR_COLORYELLOW );
			LogItem(
				CHAR_getChar( charaindex, CHAR_NAME ), /* Æ½ÅÒ·Â   */
				CHAR_getChar( charaindex, CHAR_CDKEY ),
...
void CHAR_DropItem( int charaindex,  int itemcharaindex )
{
...
#ifdef _AVID_TRADETRYBUG  //¶ªµÀ¾ß×°±¸
	if( CHAR_getWorkInt(charaindex, CHAR_WORKTRADEMODE) != CHAR_TRADE_FREE){
		CHAR_talkToCli( charaindex, -1, "±³È¯ »óÅÂ¿¡¼­´Â ¾ÆÀÌÅÛÀ» ¹ö¸± ¼ö ¾ø½À´Ï´Ù¡£", CHAR_COLORYELLOW );
		return;
	}
#endif
#ifdef _LOCK_PET_ITEM
	if (ITEM_getInt(itemindex,ITEM_ItemLock) == 1){
		CHAR_talkToCli( charaindex, -1, "°ó¶¨µÄÎïÆ·²»ÄÜ¶ªÆú£¡", CHAR_COLORYELLOW );
		return;
	}
#endif
#ifdef _DROPCHECK2
	...
	for( i = x-CHAR_DEFAULTSEESIZ/2 ; i <= x+CHAR_DEFAULTSEESIZ/2 ; i++ ){
		...
		if( count_item > 80 || count_chara > 80 ) {
			CHAR_talkToCli( charaindex, -1, "ÁÖº¯¿¡ ¾ÆÀÌÅÛÀÌ ¸¹¾Æ ¹ö¸®½Ç ¼ö ¾ø½À´Ï´Ù¡£", CHAR_COLORYELLOW );
			return;
		}
#ifdef _DROPSTAKENEW
			}
			...
			for (j = 0; j < arraysizeof(casinomap); j++){
				if (CHAR_getInt(charaindex, CHAR_FLOOR) == casinomap[j].casinofl){
					if (x == casinomap[j].casinox && y == casinomap[j].casinoy){
						...
						casinoflag = 1;
						if(casinomap[j].dropflag == 0){
							CHAR_talkToCli(charaindex, -1, "º£ÆÃÀ» ÇÒ ¼ö ¾ø½À´Ï´Ù£¡", CHAR_COLORYELLOW);
							return;
						}else{
							snprintf(tmpbuf, sizeof(tmpbuf), "´ç½ÅÀº %s º¹±Ç °¡°Ý¿¡ º£ÆÃ ÇÕ´Ï´Ù", casinomap[j].casinoinfo);
							if(dropflag >= MAXSTAKENUM){
								snprintf(tmpbuf, sizeof(tmpbuf), "´ç½ÅÀº ÀÌ¹Ì ´Ù¼¸¹øÀÇ º£ÆÃÀ» ÇÏ¿© ´õÀÌ»ó º£ÆÃÀÌ ºÒ°¡´É ÇÕ´Ï´Ù£¡");
								CHAR_talkToCli(charaindex, -1, tmpbuf, CHAR_COLORYELLOW);
								return;
							}
	...
	for( object=MAP_getTopObj(fl,x,y) ; object ; object =  NEXT_OBJECT(object ) ){
		...
		if( objtype == OBJTYPE_NOUSE )continue;
			...
			if( strcmp( getItemup(), "·ñ" ) == 0 ){
				if(strcmp(ITEM_getChar( itemindex, ITEM_CDKEY), 
						...
						if(ITEM_getInt(itemindex, ITEM_ID)!=12808 && ITEM_getInt(itemindex, ITEM_ID)!=2400 && ITEM_getInt(itemindex, ITEM_ID)!=2174){
							CHAR_talkToCli( charaindex, -1, "¡¾ÎÂÜ°ÌáÊ¾¡¿±ðÈË¶ªµÄ¶«Î÷²»ÄÜ¼ñÅ¶£¡", CHAR_COLORYELLOW);
							return -6;
						}
				}
			}
			...
			if(ITEM_getInt(itemindex, ITEM_ID) == CASINOTOKENID){
					...
					if(fl == casinomap[i].casinofl){
						if(x == casinomap[i].casinox && y == casinomap[i].casinoy){
							...
							if(casinomap[i].dropflag == 0){
								CHAR_talkToCli(charaindex, -1, "Áö±ÝÀº º£ÆÃ¾ÆÀÌÅÛÀ» Ã£À¸½Ç ¼ö ¾ø½À´Ï´Ù£¡", CHAR_COLORYELLOW);
								return -1;
							}
							stakeflag = CHAR_getWorkInt(charaindex, CHAR_WORKSTAKEFLAG);
							if(stakeflag == 0){
								CHAR_talkToCli(charaindex, -1, "´ç½ÅÀº º£ÆÃÇÑ ¾ÆÀÌÅÛÀÌ Á¸ÀçÇÏÁö ¾Ê½À´Ï´Ù£¡", CHAR_COLORYELLOW);
								return -1;
							}
							...
							if(stakeflag < 0){
								...
								CHAR_setWorkInt(charaindex, CHAR_WORKSTAKEFLAG, stakeflag);
							if(pickupflag == 0){
								CHAR_talkToCli(charaindex, -1, "º£ÆÃÀ» ÇÏ½Å ³»¿ªÀÌ ¾ø½À´Ï´Ù£¡", CHAR_COLORYELLOW);
								return -1;
							}
						}
					}
				...
				if(bdropstake == 0 && casinoflag != 0){// ´ËµØ·½µÄ²ÊÈ¯ÊýÁ¿³¬¹ýÒ»ÕÅÒÔÉÏ
					char tmpbuf[256];
					...
					snprintf(tmpbuf, sizeof(tmpbuf), "º£ÆÃÀÌ Ãë¼ÒµÇ¾ú½À´Ï´Ù.%s ¾ÆÀÌÅÛÀ» µ¹·Á¹Þ½À´Ï´Ù£¡",
						ITEM_getChar(itemindex, ITEM_NAME));
			...
			if(ret == CHAR_getMaxInventory( charaindex ) ){
				...
				pickupfunc = (PICKUPFUNC)ITEM_getFunctionPointer(itemindex, ITEM_PICKUPFUNC);
				if( pickupfunc){
			...
			*objindex = index;
			...
			if( CHAR_getInt( pindex, CHAR_WHICHTYPE) == CHAR_TYPEPET ) {
...
#endif
				{
					if( !strcmp( CHAR_getChar( pindex, CHAR_OWNERCDKEY), "SYSTEM_WAYI" ) &&
						...
						if( strcmp( CHAR_getChar( pindex, CHAR_OWNERCDKEY), CHAR_getChar( charaindex, CHAR_CDKEY) ) ||
							...
							CHAR_talkToCli( charaindex, -1, "¡¾ÎÂÜ°ÌáÊ¾¡¿±ðÈË¶ªµÄ³èÎï²»ÄÜ¼ñÅ¶£¡", CHAR_COLORYELLOW);
							return -5;
						}
					}
				}
				...
				if( CHAR_getInt( pindex, CHAR_MAILMODE) != CHAR_PETMAIL_NONE){
					...
					PETMAIL_delPetMailTotalnums( 1); //ÊÖ¶¯¼ñÆðmail PET
	...
	for( i = 0 ; i < searchloopcount ; i ++ ){
		...
		case 0:
			CHAR_ObjectDelete(objindex);
			{
				...
				if(ITEM_getInt(contents, ITEM_ID) == CASINOTOKENID && dropflag == 1)
					snprintf( mesg,sizeof(mesg), "º£ÆÃÀº ÀÌ¹Ì Ãë¼ÒµÇ¾ú½À´Ï´Ù.%s ¾ÆÀÌÅÛÀ» µ¹·Á¹Þ½À´Ï´Ù£¡",
					ITEM_getAppropriateName(contents));
				else
#endif
				snprintf( mesg,sizeof(mesg), "%s(À»)¸¦ ÁÖ¿ü¾î¿ä",
						  ITEM_getAppropriateName(contents) );
				CHAR_talkToCli(charaindex,-1,mesg,CHAR_COLORWHITE);
			}
		...
		case 1:
			...
			}
			{
				char    mesg[256];
				if( contents == 0 ) {
					snprintf( mesg,sizeof(mesg), "¼ÒÁöÇÏ°íÀÖ´Â ½ºÅæÀÌ ³Ê¹« ¸¹½À´Ï´Ù¡£" );
				}else {
					snprintf( mesg,sizeof(mesg), "%d ½ºÅæÀ» ÁÖ¿ü½À´Ï´Ù¡£",contents );
				}
				CHAR_talkToCli(charaindex,-1,mesg,CHAR_COLORWHITE);
			}
			if( contents != 0 ){
		...
		case 2:	//³èÎï
			...
			CHAR_setWorkInt( contents, CHAR_WORKOBJINDEX, -1);
			{
				...
				snprintf( mesg,sizeof(mesg), "%s(À»)¸¦ ÁÖ¿ü½À´Ï´Ù¡£", p);
				CHAR_talkToCli(charaindex,-1,mesg,CHAR_COLORWHITE);
			}
			// Ê¸ÓÀÐþÃ«½ºÔÈÐ×·òºë
			...
			LogPet(
				...
				CHAR_getInt( charaindex,CHAR_X ),
				CHAR_getInt( charaindex,CHAR_Y ),
				CHAR_getChar( contents, CHAR_UNIQUECODE),
				contents,
				charaindex
			);
			return;
		...
		case -1:
			break;
		case -2:
			CHAR_talkToCli( charaindex,-1,"¾ÆÀÌÅÛÀÌ °¡µæ Ã¡½À´Ï´Ù¡£", CHAR_COLORRED);
			break;
		case -3:
			CHAR_talkToCli( charaindex,-1,"ÆäÆ®°¡ °¡µæ Â÷¼­ ÁÖ¿ï ¼ö ¾ø½À´Ï´Ù¡£", CHAR_COLORRED);
			break;
		case -4:
			CHAR_talkToCli( charaindex,-1,"·¹º§ÀÌ ³·¾Æ ÆäÆ®¸¦ ÁÖ¿ï ¼ö ¾ø½À´Ï´Ù¡£", CHAR_COLORRED);
			break;
		case -5:
			CHAR_talkToCli( charaindex,-1,"ÀÌ ÆäÆ®´Â ÁÖ¿ï ¼ö ¾ø½À´Ï´Ù¡£", CHAR_COLORRED);
			break;
		case -6:
			CHAR_talkToCli( charaindex,-1,"¾ÆÀÌÅÛÀ» ÁÖ¿ì½Ç ¼ö ¾ø½À´Ï´Ù.", CHAR_COLORRED);
			break;
		default:
			return;
		}
...
/*------------------------------------------------------------
 * ÔÆàÅÃ«Õç  Ï¶ÀÃÆ¥  ¹«µ¤ÎçÔÊÔÂ£ÛCHAR_DropMoney¾®ÈÕ¼°ÐÄÆ¥Òøµ¤ÒÇ£Û
 * Â¦ÐÑ
 *  charaindex  int     Æ½ÅÒ·ÂÄÌ¼þ·¸ÓÀÛÍµ©
 *  itemindex   int     Ê§ÄÌ  Ø©ÄÌ¼þ·¸ÓÀÛÍµ©(Æ½ÅÒ·Â·¸¡õÕý¼°  Æ¥¼°)
 *  fl          int     °×·òÊ§
 *  x           int     x
 *  y           int     y
 *  force       BOOL    ³ð¼°°À»¥¿Ò·ÖÎç    ãù    ÔÊ
 *  objindex    int*      ÖÐÐ×Ê§ÄÌ  Ø©¼° Object Æ¥¼°ÄÌ¼þ·¸ÛÍÓÀµ©
 * ß¯Ô»°À
 *  ÁÃ  (¹«ÊÏØ¦±åÔÆàÅÃ«  ÔÈ»¯ÖÐØ¦ÖÐ)    -1
 *  ÁÃ  (»©äß¶Á±å·Ö»§)  -2
 *  ¹«Ä¾¶¯Â½¼°ÁÃ    -3
 *  ÁÃ  (¹«³ð±å·´¹«¼°ÐÚ¼°ÔÆàÅ·´ÄôÔÊ¿ºÔÂ)    -4
 *  ÔÊÆ¥±åÖ°¼°Ê§ÄÌ  Ø©»¥  ÇÐ»¯ÖÐÔÂ  -5
 *  ÐÚ»¥  Æ¥  £Û -6
 *  ÔÀ      0
 ------------------------------------------------------------*/
static BOOL CHAR_DropMoneyFXY( int charaindex, int amount, int fl , int x,int y, BOOL force, int* objindex )
{
	OBJECT  object;
	int MaxGold;
	...
	/* ³ð³ðÒýÆ¥²÷ÇíÔÊÔÂÎçÖÐµ¤ÒÇ·´Þ¥½îè¶  ÔÊÔÂ */
	{
		Object  one;
...
void CHAR_DropMoney( int charaindex,  int amount )
{
	...
	if( CHAR_getWorkInt( charaindex, CHAR_WORKTRADEMODE) == CHAR_TRADE_TRADING ){
		CHAR_talkToCli( charaindex, -1, "±³È¯ »óÅÂ¿¡¼­´Â ½ºÅæÀ» ¹ö¸± ¼ö ¾ø½À´Ï´Ù¡£", CHAR_COLORYELLOW );
		return;
	}
#endif
#ifdef _ALLBLUES_LUA_1_9
...
#ifdef _DROPSTAKENEW
		{
			...
			for(j = 0; j < arraysizeof(casinomap); j++)
			{
				if(CHAR_getInt(charaindex, CHAR_FLOOR) == casinomap[j].casinofl)
				{
					if (x == casinomap[j].casinox && y == casinomap[j].casinoy)
					{
						CHAR_talkToCli(charaindex, -1, "¿©±â¿¡´Â ¹èÄ¡ÇÒ ¼ö ¾ø½À´Ï´Ù£¡", CHAR_COLORYELLOW);
						return;
					}
				}
			}
...
int CHAR_pickupFollowPet( int charaindex, int pickupindex )
{
	...
	if( havepetindex == -1 ) {
		CHAR_talkToCli(charaindex,-1,"³èÎïÀ¸ÒÑÂú£¡ÎÞ·¨Ê°»Ø£¡",CHAR_COLORYELLOW);
		return FALSE;
	}
	...
	/* CDKEY ÎçÆ½ÅÒ·Â  »¥ÓòÚÛØÆØ¦ÖÐÎçÎå·´½ºÒüØ¦ÖÐ */
...
#ifdef _DROPSTAKENEW
// casinotype : flg = 0 ²»·Ötype£¬Õë¶ÔÕû²ãtype×öÉè¶¨£»À©³ä²ÎÊý
...
int CasinoAccumulation(int charindex, int npcindex, int floor, int wincasinotype)
{
	...
	snprintf(tmpbuf, sizeof(tmpbuf), "µµÇÕ[%4d] Æ÷ÀÎÆ® Àû¸³", accumulation);
...
void CHAR_movePetItem( int charaindex, int petid, int fromindex, int toindex )
{
	...
	int petindex = CHAR_getCharPet( charaindex, petid);
	char token[512];
	if(toindex == -1 && fromindex >= CHAR_EQUIPPLACENUM && fromindex < CHAR_getMaxInventory( charaindex )){
		...
		if(fromindex<CHAR_PETITEMNUM){
			CHAR_talkToCli( charaindex, -1, "ÆäÆ®ÀåÂø ¾ÆÀÌÅÛÀº ¹ö¸®½Ç ¼ö ¾ø½À´Ï´Ù¡£", CHAR_COLORYELLOW );
		}else{
#ifdef _NB_CDKEYLOCK
			char *cdkey = CHAR_getChar(charaindex, CHAR_CDKEY);
			if (sasql_getLock(cdkey) > 0){
				CHAR_talkToCli(charaindex, -1, "ÄãµÄÕÊºÅ´æÔÚ·Ç·¨²Ù×÷£¬ÎÞ·¨¶ªÆú³èÎïÉíÉÏÎïÆ·£¡", 6);
				return ;
			}
#endif
			...
			if(CHAR_getInt(charaindex,CHAR_LOCKED)==1 && getItemPetLocked() == 1){
				...
				char	buf[256];
				int fd = getfdFromCharaIndex( charaindex );
				sprintf( message, "ÇëÊäÈëÄãµÄ°²È«ÃÜÂë½øÐÐ½âËø£¡\n");
	...
	if( (fromindex >=0 && fromindex < CHAR_PETITEMNUM && toindex >= CHAR_EQUIPPLACENUM && toindex < CHAR_getMaxInventory( charaindex )) 
		|| (toindex >=0 && toindex < CHAR_PETITEMNUM && fromindex >= CHAR_EQUIPPLACENUM && fromindex < CHAR_getMaxInventory( charaindex ))){
		if(fromindex >= CHAR_EQUIPPLACENUM){
			...
			if(CHAR_getInt(petindex, CHAR_VARIABLEAI) < 100){
				CHAR_talkToCli( charaindex, -1, "±×°ÍÀ» ÆäÆ®°¡ Âø¿ëÇÒ ¼ö ¾ø½À´Ï´Ù¡£", CHAR_COLORRED );
				return;
			}
			*/
#ifdef _NB_LUA_MovePetItem
				//Íæ¼ÒË÷Òý,³èÎïË÷Òý,µÀ¾ßË÷Òý,³è×°Ë÷Òý,µÀ¾ßÎ»ÖÃ,×°±¸Î»ÖÃ
				if(FreeMovePetItem(charaindex,petindex, charitemindex, petitemindex,fromindex,toindex) == 0){
					return;
				}
#endif
			if(type<ITEM_PET_HEAD || type>ITEM_PET_FEET || (type-ITEM_PET_HEAD) != toindex){
				CHAR_talkToCli( charaindex, -1, "±×°ÍÀ» Âø¿ëÇÒ ¼ö ¾ø½À´Ï´Ù¡£", CHAR_COLORWHITE );
				return;
			}
			if( CHAR_getInt( petindex, CHAR_LV) < ITEM_getInt( charitemindex, ITEM_LEVEL)){
				CHAR_talkToCli( charaindex, -1, "ÆäÆ®°¡ Âø¿ëÇÏ±â¿¡ ·¹º§ÀÌ ºÎÁ·ÇÕ´Ï´Ù£¡", CHAR_COLORYELLOW );
				return;
			}
			if( ITEM_CHECKINDEX( petitemindex)){
				sprintf( token, "³èÎï%s Ð¶ÏÂ%s", CHAR_getChar( petindex, CHAR_NAME), ITEM_getChar( petitemindex, ITEM_NAME));
				CHAR_talkToCli( charaindex, -1, token, CHAR_COLORWHITE );
			}
			sprintf( token, "³èÎï%s ×°±¸%s", CHAR_getChar( petindex, CHAR_NAME), ITEM_getChar( charitemindex, ITEM_NAME));
			CHAR_talkToCli( charaindex, -1, token, CHAR_COLORWHITE );
			...
			if( ITEM_CHECKINDEX( charitemindex)){
				/*
				if(CHAR_getInt(petindex, CHAR_VARIABLEAI) < 100){
					CHAR_talkToCli( charaindex, -1, "ÎÞ·¨Ñµ·þ³èÎï×°±¸¸ÃÎïÆ·(ÖÒ³Ï²»×ã)¡£", CHAR_COLORRED );
					return;
				}
				if (CHAR_getInt( charaindex, CHAR_RIDEPET ) == petid ){
					CHAR_talkToCli( charaindex, -1, "Æï³ËÖÐµÄ³èÎÞ·¨×°±¸¸ÃÎïÆ·¡£", CHAR_COLORRED );
					return;
				}
				*/
#ifdef _NB_LUA_MovePetItem
...
#endif	
				if(type<ITEM_PET_HEAD || type>ITEM_PET_FEET || (type-ITEM_PET_HEAD) != toindex){
					CHAR_talkToCli( charaindex, -1, "ÎÞ·¨×°±¸¸ÃÏîÎïÆ·¡£", CHAR_COLORWHITE );
					return;
				}
				if( CHAR_getInt( petindex, CHAR_LV) < ITEM_getInt( charitemindex, ITEM_LEVEL)){
					CHAR_talkToCli( charaindex, -1, "³èÎïµÈ¼¶ÉÐÎ´µ½´ï×°±¸¸ÃÏîÎïÆ·£¡", CHAR_COLORYELLOW );
					return;
				}
				sprintf( token, "³èÎï%s ×°±¸%s", CHAR_getChar( petindex, CHAR_NAME), ITEM_getChar( charitemindex, ITEM_NAME));
				CHAR_talkToCli( charaindex, -1, token, CHAR_COLORWHITE );
